...
const links = [
    {link:"/home",name:"Home"},
    {link:"/dictonary",name:"Dictonary"},
    {link:"/defination",name:"Defination"}
]
const Navbar=(props)=>{
    return(
        <>
            ...
            <a href="https://flowbite.com/" className="flex items-center">
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Dictonary</span>
            </a>
            <div className="flex md:order-2">
                ...
                <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    {links.map((link)=>(
                        <li><NavLink key={link.name}
                        to={link.link}
                        aria-current="page"
                        className={(isActive)=>{
                            return (isActive.isActive ? "block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" : 
